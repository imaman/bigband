...
export class Packager {
  ...
  private async compile(relativeTsFile: string, relativeOutDir: string, nameInSection: string) {
    console.log('packager.compile ' + relativeTsFile  + ' rootdir= ' + this.rootDir)
    ...
    const filesToCompile = startingPoints.join(' ')
    logger.silly(`Compiling ${filesToCompile}`);
    console.log('filetocompile=' + filesToCompile)
